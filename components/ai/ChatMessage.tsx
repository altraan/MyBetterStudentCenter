        ...
        {isEditing ? (
          <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-end gap-2 text-xs">
              ...
              <button onClick={handleSave} className="bg-white/20 px-2 py-1 rounded hover:bg-white/30">Save</button>
            </div>
          </div>
        ) : (
          <>
            ...
            <div className={`absolute top-2 ${isUser ? '-right-12' : '-left-12'} flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition`}>
              <button
