  ...
  return (
    <div className="w-64 bg-gray-900 text-white h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <h3 className="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('recentHistory')}</h3>
        {sessions.map((session) => (
          ...
          >
            <span className="truncate text-sm me-2">{session.title}</span>
            <button
              onClick={(e) => {
                e.stopPropagation();
