      ...
      <div className="p-8 max-w-4xl mx-auto pt-24">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
            <h2 className="text-xl font-semibold">{t('systemUsers')}</h2>
            <button className="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700">{t('addNewUser')}</button>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead>
                <tr>
                  ...
                  <th className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider">{t('id')}</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-green-500">{t('active')}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                    <button className="text-purple-600 hover:text-purple-900">{t('edit')}</button>
                  </td>
                </tr>
              </tbody>
            </table>
