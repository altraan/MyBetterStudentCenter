  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-8 max-w-4xl mx-auto pt-24">
        <h1 className="text-3xl font-bold mb-6 text-blue-900">{t('addDropActivity')}</h1>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider">{t('action')}</th>
                <th className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider">{t('enrollmentID')}</th>
              </tr>
            </thead>
        ...
        <div className="mt-8 p-6 bg-yellow-50 border-s-4 border-yellow-400">
          <h4 className="text-sm font-bold text-yellow-800 uppercase">{t('importantNote')}</h4>
